...
profileRouter.put("/me", authRequired, async (req, res) => {
...
profileRouter.put("/me/password", authRequired, async (req, res) => {
 ...
 */
profileRouter.delete("/me", authRequired, async (req, res) => {
    const userId = req.user.id;
